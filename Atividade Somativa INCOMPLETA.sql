DROP SCHEMA IF EXISTS `AtividadeSomativa` ;
CREATE SCHEMA `AtividadeSomativa` ;

DROP TABLE IF EXISTS AtividadeSomativa.ITENS;
DROP TABLE IF EXISTS AtividadeSomativa.PEDIDOS;
DROP TABLE IF EXISTS AtividadeSomativa.TELEFONES;
DROP TABLE IF EXISTS AtividadeSomativa.ENDERECOS;
DROP TABLE IF EXISTS AtividadeSomativa.CLIENTES;
DROP TABLE IF EXISTS AtividadeSomativa.ENTREGADORES;
DROP TABLE IF EXISTS AtividadeSomativa.SANDUICHES;
...
SELECT * FROM AtividadeSomativa.SANDUICHES;
SELECT * FROM AtividadeSomativa.ENTREGADORES;
SELECT * FROM AtividadeSomativa.CLIENTES;
SELECT * FROM AtividadeSomativa.ENDERECOS;
SELECT * FROM AtividadeSomativa.TELEFONES;
SELECT * FROM AtividadeSomativa.PEDIDOS where StatusPedido = 0;
SELECT * FROM AtividadeSomativa.ITENS where CodPedido in (select CodPedido from AtividadeSomativa.PEDIDOS where StatusPedido = 0);
